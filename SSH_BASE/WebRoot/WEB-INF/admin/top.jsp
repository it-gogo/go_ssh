...
<body style="background:url(<%=request.getContextPath() %>/css/admin/images/topbg.gif) repeat-x;">
    ...
    <ul class="nav">
	    ...
	    <li><a href="buserAction!lookInfo.action" target="rightFrame"><img src="<%=request.getContextPath() %>/css/admin/images/icon01.png" title="用户信息" /><h2>用户信息</h2></a></li>
	    <li><a href="buserAction!toModifyPW.action"  target="rightFrame"><img src="<%=request.getContextPath() %>/css/admin/images/icon06.png" title="修改密码" /><h2>修改密码</h2></a></li>
    </ul>
