...
<body>
	...
	<div class="formbody">
	    ...
	    <form action="codedataAction!savexx.action" method="post" id="pform"  >
	    <input type="hidden"  name="vo.id" id="ids" value="${vo.id }"/>
	    <input type="hidden"  name="vo.typeid" id="typeid" value="${typeid}"/>
	    <ul class="forminfo">
		    <li>
		    	<label>名称<b>*</b></label>
				<input type="text" name="vo.cname" class="dfinput requires" value="${vo.cname }"  />
		    </li>
		    <li>
		    	<label>编码</label>
				<input type="text" name="vo.code" class="dfinput" value="${vo.code }"    />
		    </li>
		    <li>
		    	<label>是否启用</label>
		    	<cite>
