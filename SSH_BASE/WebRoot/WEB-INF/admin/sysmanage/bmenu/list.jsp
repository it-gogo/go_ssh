...
<body>
	...
	<div class="rightinfo">
		<div class="tools">
			<form action="bmenuAction!searchList.action" method="post" id="searchForm">
				<input type="hidden" id="pmcode" name="pmcode_right" value="${parame['pmcode_right'][0] }"  />
				<ul class="seachform" style="float: left;">
				    <li><label>名称</label><input name="mname_like" value="${parame['mname_like'][0] }" type="text" class="scinput" /></li>
				    <li>
			...
			<ul class="toolbar1">
				...
				<li onclick="deleteAll('bmenuAction!deletexx.action');">
			...
			<tbody>
				<s:iterator value="pageBean.list">
					<tr>
						...
						<td>
							<a href="javascript:void(0);" onclick="deleteOne('${id}','bmenuAction!deletexx.action');" class="tablelink"> 删除</a>
							<a href="bmenuAction!updatexx.action?id=${id}" class="tablelink">修改</a> 
							<a href="javascript:void(0);" onclick="changeStatus('${id}','${isactives }','bmenuAction!changeStatus.action');" class="tablelink">
